...
return [
    ...
    "services_intro" => "I have expertise in Product Discovery and Delivery, enhancing User Engagement, leading cross-functional teams with effective Team Leadership, and offering insightful Market Analysis to drive strategic decisions and optimize product performance.",
    "services_title" => "What I Do",
    "service" => "My expertise",

    "skills_title" => "Skillset",
    "whyme" => "What do I bring to the table?",
    "whyme_desc" => "I specialize in the intersection of UX/CX, tech, and business, bringing a unique skill set that drives growth and business agility. I am the \"sheep with five legs\" that everyone is looking for",

    "skill1" => "Product Development and Management",
    "skill2" => "User centricity and Data-driven Decision Making",
    "skill3" => "E-Commerce and customer journeys",
    ...
    "skill10" => "Programming (PHP, .Net, HTML, CSS, JavaScript, SQL)",
    "skill11" => "Revenue Growth and Monetization",
    "skill12" => "Market Research and Analysis",
    "skill13" => "Data Science, AI & Machine learning",
    ...
    "portfolio_text" => "Explore some examples of products and online campaigns I've successfully delivered and launched, which grew brand user bases by up to 2500% and significantly boosted retention and engagement KPIs.",
    ...
    "gstar_title" => "Product Lead for G-star RAW Global E-commerce (Web & App), a renowned European fashion retailer with millions of customers in 50 countries.",
    ...
    "denksport_title" => "Head of Products, Global e-commerce for Denksport, a renowned puzzle brand with millions of customers.",
    "zula_title" => "Head of Product Growth in MENA for Zula, a popular PC & mobile First Person Shooter game with more than 5 million players.",
